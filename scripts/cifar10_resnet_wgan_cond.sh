...
python run.py --name $name --dataset cifar10 --generator_adversarial_objective wgan\
 ...
 --discriminator_spectral 0 --gradient_penalty_weight 10 --lr_decay_schedule linear --number_of_epochs 100 --gan_type AC_GAN --arc res --training_ratio 5 --generator_batch_multiple 2
