...
CUDA_VISIBLE_DEVICES=0 python run.py --name $name --dataset cifar10 --arc res\
 ...
 --g_decomposition zca --g_iter_num 7 --g_whitten_m 128 --g_coloring_m 0 --g_instance_norm 0\
 --discriminator_norm n --discriminator_coloring n\
 --d_decomposition zca --d_iter_num 7 --d_whitten_m 128 --d_coloring_m 128 --d_instance_norm 0\
