...
os.system('python run.py --name {} --dataset cifar10 --generator_adversarial_objective wgan\
          ...
          --discriminator_spectral 0 --gradient_penalty_weight 10 --lr_decay_schedule linear --number_of_epochs 100 --gan_type AC_GAN --filters_emb 4  --arc res --training_ratio 5 --generator_batch_multiple 2'.format(name))
name = base_name + '_pca'
print(name)
os.system('python run.py --name {} --dataset cifar10 --generator_adversarial_objective wgan\
          --discriminator_adversarial_objective wgan  --generator_block_norm d --generator_block_after_norm ufconv\
