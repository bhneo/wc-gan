...
os.system('python run.py --name {} --dataset cifar10 --generator_adversarial_objective hinge\
          ...
          --discriminator_spectral 1 --gradient_penalty_weight 0 --lr_decay_schedule linear --number_of_epochs 2  --arc dcgan --training_ratio 1 --generator_batch_multiple 1'.format(base_name))
