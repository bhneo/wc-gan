...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --d_decomposition pca --d_iter_num 5 --d_whitten_m 4 --d_coloring_m 0 --d_instance_norm 1\
          ...
          --number_of_epochs 11 --batch_size 64'.format(base_name))
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition pca --d_iter_num 5 --d_whitten_m 16 --d_coloring_m 0 --d_instance_norm 1\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition pca --d_iter_num 5 --d_whitten_m 32 --d_coloring_m 0 --d_instance_norm 1\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition pca --d_iter_num 5 --d_whitten_m 16 --d_coloring_m 0 --d_instance_norm 0\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition pca --d_iter_num 5 --d_whitten_m 32 --d_coloring_m 0 --d_instance_norm 0\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition zca --d_iter_num 5 --d_whitten_m 4 --d_coloring_m 0 --d_instance_norm 1\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition zca --d_iter_num 5 --d_whitten_m 32 --d_coloring_m 0 --d_instance_norm 1\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition zca --d_iter_num 5 --d_whitten_m 16 --d_coloring_m 0 --d_instance_norm 0\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --discriminator_norm d\
          --discriminator_coloring uconv\
          --d_decomposition zca --d_iter_num 5 --d_whitten_m 32 --d_coloring_m 0 --d_instance_norm 0\
          --discriminator_filters 256 --generator_filters 256\
          --discriminator_spectral 1\
          --gradient_penalty_weight 0\
          --lr_decay_schedule linear --generator_lr 2e-4 --discriminator_lr 2e-4\
