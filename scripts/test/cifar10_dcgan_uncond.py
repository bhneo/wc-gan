...
os.system('python run.py --name {} --dataset cifar10\
          ...
          --d_decomposition zca --d_iter_num 5 --d_whitten_m 32 --d_coloring_m 1 --d_instance_norm 1\
          --g_decomposition zca --g_iter_num 5 --g_whitten_m 32 --g_coloring_m 1 --g_instance_norm 1\
