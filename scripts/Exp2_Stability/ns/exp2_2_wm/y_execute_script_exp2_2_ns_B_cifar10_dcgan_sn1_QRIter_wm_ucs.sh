   ...
   do 
      ...
      do	
        ...
        do
          for ((b=0;b<$f;++b))
          do
                name="exp2_1_${dataset}_${arc}_B_sn${discriminator_spectral}_G${Gmethods[$a]}_${generator_block_coloring}_Gins${g_instance_norm}_GW${Gm[$j]}_f${discriminator_filters}_bs${BatchSize[$k]}_${LRs[$i]}_s${seeds[$b]}_C${Count}"
   	            echo "${name}"
