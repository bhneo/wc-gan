...
os.system('python run.py --name {} --dataset cifar10 --generator_adversarial_objective hinge\
          ...
          --discriminator_spectral 1 --gradient_penalty_weight 0 --lr_decay_schedule linear --number_of_epochs 100  --arc dcgan --training_ratio 1 --generator_batch_multiple 1'.format(name))
name = base_name + '_pca'
print(name)
os.system('python run.py --name {} --dataset cifar10 --generator_adversarial_objective hinge\
          --discriminator_adversarial_objective hinge  --generator_block_norm d --generator_block_after_norm uconv\
